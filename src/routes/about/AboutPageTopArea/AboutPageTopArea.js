    ...
    return (
        ...
        <div className="about__wrapper">
            ...
            {/* <div className="about__wrapper-box">
                <img src="img/worker2.jpg" alt="Bild på utvecklare" title="Bild på utvecklare" className="about__wrapper-box--img" />
                <h3 className="about__wrapper-box--name">Ricky Snyder</h3>
                <p className="about__wrapper-box--desc">Fullstack-utvecklare</p>
                <p className="about__wrapper-box--info">Ricky har arbetat med webbutveckling sedan slutet av 90-talet. Han är erfaren i alla möjliga språk och ramverk. Han har tidigare jobbat för stora företag i världen som IBM och Yahoo och tagit med sig erfarenheten till vårt företag. Ricky är expert inom C# och ASP.NET, men är också bekväm med ramverk som React.JS och Vue.</p>
            ...
            {/* <div className="about__wrapper-box">
                <img src="img/worker1.jpg" title="Bild på utvecklare" alt="Bild på utvecklare" className="about__wrapper-box--img" />
                <h3 className="about__wrapper-box--name">Dora Stone</h3>
                <p className="about__wrapper-box--desc">Projektledare</p>
                <p className="about__wrapper-box--info">Dora har lanserat flera stora projekt på en global nivå. Hon har arbetat världskända klienter i olika branscher. Med sitt djupt strategiska tänkande är hon en expert på att starta igång viktiga projekt och synka ihop ett välarbetande team och förvandla drömmar och visioner till en verklighet. Dora är väldigt social och duktig på att kommunicera med sina klienter.</p>
                <div className="social">
                    <i className="fab fa-linkedin-in social-icon"></i>
            ...
            {/* <div className="about__wrapper-box">
                <img src="img/worker3.jpg" title="Bild på utvecklare" alt="Bild på utvecklare" className="about__wrapper-box--img" />
                <h3 className="about__wrapper-box--name">Isaac Gilbert</h3>
                <p className="about__wrapper-box--desc">Frontend-expert</p>
                <p className="about__wrapper-box--info">Isaac har specialiserat sig inom frontend-teknik sedan många år tillbaka. Med sin enorma passion för frontend så har han producerat kvalitetsprodukter för flera utav världens IT-jättar som Facebook och Amazon. JavaScript är hans bekväma sida, och han är väldigt bekant med moderna utvecklingsverktyg som Webpack, NPM och annat.</p>
                <div className="social">
